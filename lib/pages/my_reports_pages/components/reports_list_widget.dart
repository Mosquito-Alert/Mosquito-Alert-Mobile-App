...
class _MyReportsListState extends State<ReportsList> {
  ...
  String getTitle(BuildContext context, Report report) {
    switch (report.type) {
      ...
      case 'bite':
        var response_question_1 = report.responses
            ?.firstWhere((element) => element!.question == 'question_1');
      ...
      case 'site':
        var response_question_12 = report.responses
            ?.firstWhere((element) => element!.question == 'question_12');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: reports.isEmpty
            ? Center(
                child: Text(MyLocalizations.of(context, 'no_reports_yet_txt')), // TODO: Translate
              )
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Card(
                    ...
                    elevation: 4.0,
                    child: ListTile(
                      leading: reports[index].type == 'bite'
                          ? null
                          : Container(
                              width: 56,
                              height: 56,
                      ...
                      subtitle: RichText(
                        text: TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text:
                                  ' ${formatCreationTime(reports[index].creation_time)}',
                              style: TextStyle(
                                fontWeight: FontWeight.normal,
                                color: Colors.grey,
                              ),
